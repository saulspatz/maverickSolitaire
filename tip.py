    ...
    def configure(self, **kwargs):
        for k,v in kwargs.items():
            match(k):
                case 'bg': self.bg = v
                case 'pad': self.pad = v
                case 'text': self.text = v
                case 'font': self.font = v
                case 'waittime': self.waittime = v
                case 'wraplength': self.wraplength = v
                case _:raise(ValueError, f'Unknown keyword {k} in CanvasTooltip.configure')
